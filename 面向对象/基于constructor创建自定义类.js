...
let f1 = new Fn()
let f2 = new Fn()
// js中创建值的方式有两种方式: 1.字面量方式, 2.构造函数方式
//基本数据类型基于两种不同模式创建出来的值类型是不一样的,但是都可以用数字类提供的方法
let num1 = 12 // typyof num1  => 'number'
 ...
 */
function Fn2() {
  //return // 这样只写return,是结束代码的作用,并且不会覆盖返回的实例
  // return 12
  // return {name: 'aa'} // 如果有return 引用,那么instanceof检测不出来
}
let fn21 = new Fn2()// =》 new Fn2  如果创建实例的时候不需要传参数,那么加不加小括号都没有太大的影响
/**
 * 
